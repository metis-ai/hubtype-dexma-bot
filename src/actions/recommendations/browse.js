...
export default class extends React.Component {
  ...
  render() {
    if (this.props.wants_to_browse === 'browse_recommendations_locations') {
      return (
        <InvokeWebview
          text={_('recommendations.please_select_location')}
          webview_height_ratio={'tall'}
          webview_url={'/webviews/browse_locations'}
          button={_('recommendations.location.select_location')}
        />
      )
    } else {
